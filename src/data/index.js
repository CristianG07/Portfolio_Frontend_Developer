...
export const SocialLinks = [
   { id: 1, icon: "bi:github", href: "https://github.com/CristianG07" },
   { id: 2, icon: "pixel:linkedin", href: "https://www.linkedin.com/in/cristian-gonzalez-3072b1172" },
   { id: 3, icon: "ri:fiverr-fill", href: "https://www.fiverr.com/s/42E0aqy" },
]

export const AboutSkills = [
   { id: 1, text: "Clean Code", icon: "jam:code" },
   { id: 2, text: "Responsive Design", icon: "qlementine-icons:computer-16" },
   { id: 3, text: "Performance", icon: "streamline-plump:flash-1-remix" },
   { id: 4, text: "Problem solver", icon: "pajamas:issue-type-maintenance" },
   { id: 5, text: "UI/UX Focus", icon: "streamline-pixel:ui-design-website" },
]
